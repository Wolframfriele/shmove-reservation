  ...
  >
    <v-toolbar color="teal">
      ...
      <v-card-actions>
        ...
        <v-spacer></v-spacer>
        <v-btn color="red" @click="deleteCheck = true" class="white--text">Verwijder Klant</v-btn>
      </v-card-actions>
      <v-overlay v-model="deleteCheck">
        <v-card min-width="600px">
          <v-card-text>
            ...
            <br>
            <p>Pas op! Het verwijderen van een klant verwijdert ook alle bijbehorende afspraken. Dit kan niet ongedaan gemaakt worden.</p>
          </v-card-text>
          <v-card-text>
            <v-btn text color="gray" @click="deleteCheck = false">Anuleren</v-btn>
            <v-btn color="red" @click="deleteCustomer" class="white--text">Verwijder Afspraak</v-btn>
          </v-card-text>  
        </v-card>  
      </v-overlay>
  </v-card>
